		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tanabecashmanagementfilecontentupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tanabecashmanagementfilecontentupload-display": {
								"semanticObject": "tanabecashmanagementfilecontentupload",
								"action": "display",
								"description": "File Content Upload",
								"title": "File Content Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tanabe.cashmanagement.filecontentupload",
									"url": sap.ui.require.toUrl("tanabe/cashmanagement/filecontentupload")
								}
							}
						}
					}
